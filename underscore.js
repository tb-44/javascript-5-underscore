...
// Bonus Points
const totalByMonth = _.groupBy(purchasesByMonth,'month');
...
let fastFibonnaci = .memoize(function(n){
  if (n < 2) {
    return 1
  }
  return fastFibonnaci(n-1) + fastFibonnaci(n-2)
});
